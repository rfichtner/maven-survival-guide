...
git log -1 --pretty=format:"%s"
pause
open ./pizza-backend/target/dependency-check-report.html
pause 
...
git log -1 --pretty=format:"%s"
pause
open ./pizza-backend/target/site/dependencies.html
open ./pizza-backend/target/site/third-party-report.html
pause
