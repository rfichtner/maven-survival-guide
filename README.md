...
1. Find out what you are running on
...
3. Have a look and see what your effective POM looks like
...
### Bonus Level: Make build reproducible
 ...
 2. check if you caught them all with
	...
	**Note 1:** 
	> [Maven 3.8.1 will break your bulid if you have non-https URLs for repos](https://maven.apache.org/docs/3.8.1/release-notes.html#how-to-fix-when-i-get-a-http-repository-blocked)

	**Note 2:** 
	> You can use [Maven Wrapper](https://maven.apache.org/wrapper/) to bring your own Maven Version to build your project
...
### Level 4: save time, save money and the planet earth
 ...
 2. add the maven-profiler extension from [Jean-Christophe Gay](https://github.com/jcgay/maven-profiler) or [Karl Heinz Marbaise](https://central.sonatype.com/artifact/com.soebes.maven.extensions/maven-buildtime-profiler/0.2.0)

 3. find out where you can save time, money and the planet earth

    1. What (plugins) are executed in which phase?

		`mvn buildplan:list-phase`
		
    2. Profile different commands and see the differences: 
